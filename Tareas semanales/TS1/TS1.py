...
plt.plot(_,f1, 'o--',  label = 'Sinusoidal de 2kHz')
plt.legend()
plt.show()
...
plt.plot(_,f2, 'x:', label = '2kHz, amplificada y desfazada en π/2')
plt.legend()
plt.grid()
plt.show()
...
plt.xlabel('Tiempo [s]')
plt.ylabel('Amplitud [V]')
plt.plot(_, f3, 'x:', label = 'Señal modulada') # Genero el grafico de la señal
plt.legend()
plt.grid()
plt.show()
...
plt.xlabel('Tiempo [s]')
plt.ylabel('Amplitud [V]')
plt.plot(_,f5, 'o--', label = 'Señal cuadrada de 4Hz')
plt.legend()
plt.grid()
plt.show()
